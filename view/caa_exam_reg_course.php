            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo $result; ?>
                            <form class="form-horizontal" action="../controller/caa_exam_controller.php" method="post">
                               
                                <div class="form-group">
                                    <label class="control-label col-sm-2">Name of the Course :</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="indexno" type="text" name="name" placeholder="name of the course" />
                                    </div>
                                </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input class="form-control" id="schol_type" type="text" name="code" placeholder="Course code " />
                                </div>
                              </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2">Course Year  :</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="samount" type="text" name="c_year" placeholder="Course Year" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" id="samount" type="text" name="year" placeholder="year of the Degree" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" id="samount" type="text" name="credit" placeholder="credits of the Course" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2">Semester :</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="samount" type="text" name="sem" placeholder="semester of the Course" />
                                    </div>
                                </div>
                                <div class="form-group">
                                <label class="control-label col-sm-2"  for="radio">Type Of Course :</label>
                                <div class="col-sm-10">
                                   <div class="radio"><label><input type="radio" id="stype" name="type" value="m" required>Mandatory </label></div>
                                   <div class="radio"><label><input type="radio" id="stype" name="type" value="o" required>Optional </label></div>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="add-project" data-dismiss="modal" name="op" value="reg_course">
