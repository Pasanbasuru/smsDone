                                            ...
                                            <div class="table-responsive panel">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <input type="text" value="<?php echo $s_id; ?>" class="form-control" id="sid" name="s_id" placeholder="Enter name" required /></td>

                                                    </tr>

                                                    <tr>
                                                        <td class="text-success"><i class="fa fa-user"></i> First Name</td>
                                                        <td> <input type="text" value="<?php echo $fname; ?>" class="form-control" id="fname" name="firstname" placeholder="Enter name" required /></td>

                                                    </tr>
                                                    <tr>
                                                        <td class="text-success"><i class="fa fa-user"></i> Middle Name</td>
                                                        <td> <input type="text" value="<?php echo $mname; ?>" class="form-control" id="mname" name="mname" placeholder="Enter name" required /></td>
