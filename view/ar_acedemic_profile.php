                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="../controller/ar_acedemic_controller.php" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" id="fname" type="text" name="fname" placeholder=""  value=<?php echo $first_name?> disabled/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="add-project" name="op" value="update_ar_acedmic">Update</button>
                        </div>
